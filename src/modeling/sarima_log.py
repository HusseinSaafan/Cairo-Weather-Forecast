"""Train SARIMA on log(target), invert forecasts, and evaluate on test data."""
...
MODEL_ARTIFACT_PATH = os.path.join(ARTIFACTS_DIR, "sarima_log.pkl")
METRICS_ARTIFACT_PATH = os.path.join(ARTIFACTS_DIR, "sarima_log_metrics.json")
